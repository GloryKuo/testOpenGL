...
int main(int argc, char **argv)
{
	...
	//if( 0 != loadasset( argc >= 2 ? argv[1] : "../models/Bulbasaur/Bulbasaur.obj")) {
	//	if( argc != 1 || (0 != loadasset( "../models/Bulbasaur/Bulbasaur.obj") && 0 != loadasset( "../models/Bulbasaur/BR_Bulbasaur.obj"))) { 
	//		return -1;
	//	}
	//}
